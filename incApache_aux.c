...
/*** TO BE DONE 6.0 START ***/
				...
				// Faccio in modo che altri thread non possano avere race condition...
				pthread_mutex_lock(&my_timegm_mutex);
				// tz è la eevironment variable che equivale alla "time zone", utile per impostare il tempo in GMT
				tz = getenv("TZ");
...
/*** TO BE DONE 6.0 START ***/
				...
				// Riporto ai valori di default il valore di tz
				tzset();
				// Sblocco il mutex
